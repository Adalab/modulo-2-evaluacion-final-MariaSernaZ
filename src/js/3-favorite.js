...
1- Color de fondo y fuente se intercambian 
...
function handleClickFav(event){
    ...
    */
    ...
    //Buscamos el id de la serie seleccionada en el array de favoritos (favoriteShows) para comprobar si ya está en favoritos. Find nos devolverá el primer elemento o undefined
